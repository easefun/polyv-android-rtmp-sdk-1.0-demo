...
public class PLVSRelativeImageSpan extends ImageSpan {
	...
	public PLVSRelativeImageSpan(Drawable d) {
		super(d);
	}

	public PLVSRelativeImageSpan(Drawable d, int verticalAlignment) {
		super(d, verticalAlignment);
		status = verticalAlignment;
	}

	public PLVSRelativeImageSpan(Drawable d, int verticalAlignment, float spacingScale) {
		super(d, verticalAlignment);
		status = verticalAlignment;
		scale = spacingScale;
	}
